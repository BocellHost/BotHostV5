...
async function pBurnPapper(text) {
  return new Promise((resolve, reject) => {
    const options = { method: 'POST',
      url: tema.burnPapper,
      headers: { 'content-type': 'application/x-www-form-urlencoded' },
...
async function pGlitch(text, text2) {
  return new Promise((resolve, reject) => {
    const options = { method: 'POST',
      url: tema.Glitch,
      headers: { 'content-type': 'application/x-www-form-urlencoded' },
      formData: { text_1: text, text_2: text2, login: 'OK' } };
...
async function pDoubleHeart(text) {
  return new Promise((resolve, reject) => {
    const options = { method: 'POST',
...
async function pButterfly(text) {
  return new Promise((resolve, reject) => {
    const options = { method: 'POST', 
      url: tema.butterFly,
...
async function pWanted(image1, text, text2) {
  return new Promise((resolve, reject) => {
    const options = { method: 'POST', 
      url: tema.wanted,
      headers: { 'content-type': 'application/x-www-from-urlencoded' },
      formData: { image_1: image1, text_3: text, text_4: text2, login: 'OK' } };
